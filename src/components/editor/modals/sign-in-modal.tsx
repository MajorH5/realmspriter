...
export default function LoginModal() {
    ...
    return (
        <Modal
            ...
            className="!p-0 border-[1px] w-[400px] h-[370px] overflow-hidden"
        >
            ...
            <ModalBody className="px-8 w-full">
                ...
                >
                    ...
                    <p className="text-sm hover:text-[#ffda84] cursor-default select-none">New user? Click here to Register</p>
                </div>
            </ModalBody>
